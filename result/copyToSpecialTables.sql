...
CREATE TABLE IF NOT EXISTS "completeSort" as select * from stats where s like '%-Q%' or s like '%-c%';
CREATE TABLE IF NOT EXISTS "ipsoSort" as select * from stats where s like '%-4%';
...
CREATE TABLE IF NOT EXISTS "ipsoSortWithout" as select lef.s as s, lef.v - rig.v as v, lef.a as a, lef.n as n, lef.t as t from ipsoSort lef, ipsoSort rig where lef.s = rig.s and lef.a = rig.a and lef.n = rig.n and lef.i = rig.i and lef.c = 0 and rig.c = 1;