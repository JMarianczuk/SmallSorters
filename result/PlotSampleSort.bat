...
#Rscript RPlot.R --tableName="sampleSortWithout%2" --dbName="%1" --filter="s like '%%BN-R%%' and s like '%%-S%%'" --filePostfix="sample-sort-bosenelson-rec-%2" --complete=TRUE --title="SampleSort"
...
Rscript RPlot.R --tableName="sampleSortWithout%2" --dbName="%1" --filter="s like '%%-s332%%' and s not like '%%Tie%%'" --filePostfix="sample-sort-332-%2" --complete=TRUE --title="SampleSort" --percentAxis="IS      -s332 Def"
