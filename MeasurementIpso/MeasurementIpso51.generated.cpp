...
void MeasureIpso51(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration)
{
	...
	measurement::MeasureCompleteSorter<SortableRef>(perf, numberOfIterations, arraySize, measureIteration, "S+I       -4 32 KR Def", &external::IpsoWrapper<5,1>, &measurement::BaseCaseSortBlank<SortableRef>);
	randomisation::SetSeed(seed);
	measurement::MeasureCompleteSorter<SortableRef_PointerOptimized>(perf, numberOfIterations, arraySize, measureIteration, "S+I       -4 32 KR POp", &external::IpsoWrapper<5,1>, &measurement::BaseCaseSortBlank<SortableRef_PointerOptimized>);
	randomisation::SetSeed(seed);
