...
void MeasureIpso21(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration)
{
	...
	measurement::MeasureCompleteSorter<SortableRef_FourCmovTemp>(perf, numberOfIterations, arraySize, measureIteration, "S+N BoNeL -4 32 KR 4Cm", &external::IpsoWrapper<2,1>, &measurement::BaseCaseSortBlank<SortableRef_FourCmovTemp>);
	randomisation::SetSeed(seed);
	...
	randomisation::SetSeed(seed);
	measurement::MeasureCompleteSorter<SortableRef_ClangVersion>(perf, numberOfIterations, arraySize, measureIteration, "S+N BoNeL -4 32 KR Cla", &external::IpsoWrapper<2,1>, &measurement::BaseCaseSortBlank<SortableRef_ClangVersion>);
	randomisation::SetSeed(seed);
	measurement::MeasureCompleteSorter<SortableRef_ClangPredicate>(perf, numberOfIterations, arraySize, measureIteration, "S+N BoNeL -4 32 KR CPr", &external::IpsoWrapper<2,1>, &measurement::BaseCaseSortBlank<SortableRef_ClangPredicate>);
	randomisation::SetSeed(seed);
