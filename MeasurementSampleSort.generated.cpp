...
void MeasureSampleSort(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration)
{
	...
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Def", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef, uint64_t>, &networks::sortNbatcher<SortableRef>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_JumpXchg>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR JXc", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_JumpXchg, uint64_t>, &networks::sortNbatcher<SortableRef_JumpXchg>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_FourCmovTemp>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 4Cm", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_FourCmovTemp, uint64_t>, &networks::sortNbatcher<SortableRef_FourCmovTemp>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_FourCmovTemp_Split>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 4CS", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_FourCmovTemp_Split, uint64_t>, &networks::sortNbatcher<SortableRef_FourCmovTemp_Split>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_SixCmovRegisterTemp>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 6Cm", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_SixCmovRegisterTemp, uint64_t>, &networks::sortNbatcher<SortableRef_SixCmovRegisterTemp>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_ClangVersion>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Cla", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_ClangVersion, uint64_t>, &networks::sortNbatcher<SortableRef_ClangVersion>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_Tie>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Tie", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_Tie, uint64_t>, &networks::sortNbatcher<SortableRef_Tie>);
	randomisation::SetSeed(seed);
	measurement::MeasureSampleSort<SortableRef_QMark>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR QMa", &samplesort::SampleSort3Splitters3OversamplingFactor2BlockSize<SortableRef_QMark, uint64_t>, &networks::sortNbatcher<SortableRef_QMark>);
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Def");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_JumpXchg>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR JXc");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_FourCmovTemp>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 4Cm");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_FourCmovTemp_Split>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 4CS");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_SixCmovRegisterTemp>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR 6Cm");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_ClangVersion>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Cla");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_Tie>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR Tie");
	randomisation::SetSeed(seed);
	measurement::MeasureRandomGeneration<SortableRef_QMark>(perf, numberOfIterations, arraySize, measureIteration, "N BatchP -s332 KR QMa");
