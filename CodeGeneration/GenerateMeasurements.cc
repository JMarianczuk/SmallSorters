...
void WriteIpsoMethod(CPlusPlusCodeGenerator* ipsoGen, std::string ipsoMeasureName, std::string opt)
{
    ...
    CPlusPlusCodeGenerator* ipso1Gen)
{
    ...
    headerGen->WriteHeaderPragma("MEASUREMENT_GENERATED_H", [=](){
        ...
        ipso1Gen->WriteIncludeQuotes(
            ...
            "StdSortWrapper.h",
            "Ipso.h");
        WriteIpsoMethod(ipso0Gen, ipsoMeasureName, "0");
        WriteIpsoMethod(ipso1Gen, ipsoMeasureName, "1");
    });
}
