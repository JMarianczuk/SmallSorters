...
void GenerateSortableStructs()
{
    auto sortableStructsGen = 
        new CodeGenerator("../../Sortable.generated.h");
...
void GenerateStructHelpers()
{
    auto structHelpersGen = 
        new CodeGenerator("../../StructHelpers.generated.h");
...
void GenerateRandomisation()
{
    auto randomisationGen = 
        new CodeGenerator("../../Randomisation.generated.h");
...
{
    auto boseNelsonGen = 
        new CodeGenerator("../../BoseNelson.generated.h");
    WriteNetwork(
        boseNelsonGen, 
    ...
    auto bestNetworkGen = 
        new CodeGenerator("../../BestNetworks.generated.h");
    WriteNetwork(
        bestNetworkGen, 
...
{
    auto measurementGen = 
        new CodeGenerator("../../Measurement.generated.h");
...
{
    auto sampleSortGen = 
        new CodeGenerator("../../SampleSort.generated.h");
