...
void MeasureIpso61_16(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration)
{
	...
	measurement::MeasureCompleteSorter<SortableRef, RandomisationMode::DEFAULT>(perf, numberOfIterations, arraySize, measureIteration, "S+N BNRec -4 16_331 KR 4CS", &external::IpsoWrapper<6,1,16>);
	randomisation::SetSeed(seed);
