...
void MeasureIpso_Hybrid_BN_R(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
...
void MeasureIpso_BN_L_331_16(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
...
void MeasureIpso_BN_L_331_64(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
void MeasureIpso_BN_R_331_16(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
void MeasureIpso_BN_R_331_32(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
...
void MeasureIpso_BN_R_332_16(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
void MeasureIpso_BN_R_332_32(Performancing* perf, uint64_t seed, int numberOfIterations, size_t arraySize, int measureIteration);
